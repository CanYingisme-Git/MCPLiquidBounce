...
public class DefaultVertexFormats
{
    ...
    public static VertexFormat POSITION = new VertexFormat();
    public static VertexFormat POSITION_TEX = new VertexFormat();
    public static VertexFormat POSITION_COLOR = new VertexFormat();
    public static VertexFormat POSITION_TEX_COLOR = new VertexFormat();
    ...
    static
    {
        ...
        POSITION_TEX_COLOR = field_181704_d;
