...
public class GuiNewChat extends Gui
{
    ...
    private void drawChat(int p_drawChat_1_, final CallbackInfo callbackInfo) {
        ...
        if (hud.getState() && hud.getFontChatValue().get()) {
            ...
            if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
                ...
                int lvt_4_1_ = 0;
                int lvt_5_1_ = this.chatLines.size();
                ...
                if (lvt_5_1_ > 0) {
                    ...
                    int lvt_11_1_;
                    int lvt_14_1_;
                    for (lvt_9_1_ = 0; lvt_9_1_ + this.scrollPos < this.chatLines.size() && lvt_9_1_ < lvt_2_1_; ++lvt_9_1_) {
                        ChatLine lvt_10_1_ = this.chatLines.get(lvt_9_1_ + this.scrollPos);
                        if (lvt_10_1_ != null) {
    ...
    {
        CallbackInfo<Void> cb = new CallbackInfo<Void>(null);
        drawChat(p_146230_1_,cb);
        if (cb.isCancel()) return;
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN)
        {
            ...
            if (hud.getState() && hud.getFontChatValue().get()) {
                if (this.getChatOpen()) {
                    ...
                    if (lvt_6_1_ >= 0 && lvt_7_1_ >= 0) {
                        int lvt_8_1_ = Math.min(this.getLineCount(), this.chatLines.size());
                        if (lvt_6_1_ <= MathHelper.floor_float((float) this.getChatWidth() / this.getChatScale()) && lvt_7_1_ < Fonts.font40.getFontHeight() * lvt_8_1_ + lvt_8_1_) {
                            ...
                            if (lvt_9_1_ >= 0 && lvt_9_1_ < this.chatLines.size()) {
                                ChatLine lvt_10_1_ = this.chatLines.get(lvt_9_1_);
                                int lvt_11_1_ = 0;
